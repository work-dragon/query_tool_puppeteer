...
var loginInfo_1 = require("../config/loginInfo");
var navInfo_1 = require("../config/navInfo");
//login
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, navInfo.navDeviceSearch(page, waitForSelectorSearchInput, deviceIdInputSearch, deviceIdText, searchBtn, waitForSelectorSearchContent, waitForSelectorSearchContent, exportDataBtn)
                    // 退出登录
                ];
            case 6:
                _a.sent();
